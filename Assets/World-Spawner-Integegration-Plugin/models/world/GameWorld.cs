...
public class GameWorld: World {
	...
	public override void OnGenerateWorld(){

		int threadID = MultiThreading.startNewThread (BaseGameConstants.WORLD_GEN_MEMORY);
		...
		MultiThreading.doTask (threadID, () => {
			...
			MultiThreading.doOnMainThread(() => {
				...
				t.GetComponent<GameWorldData> ().terrain = terrain;
				t.GetComponent<GameWorldData> ().biome = TerrainConverter.main.type [terrain];
			...
			Thread.Sleep(BaseGameConstants.GEN_WAIT_INTERVAL);
